...
countWords:
	...
	mov	r14d, 0				#count_of_words
	mov	DWORD PTR -24[rbp], 0
	jmp	.L2
.L11:
	mov	DWORD PTR -20[rbp], 0		# j = 0
	mov	eax, DWORD PTR -24[rbp]		# symbol = argv[i +1][j]
	cdqe
	add	rax, 1
	lea	rdx, 0[0+rax*8]
...
main:
	...
	mov	rax, rsp
	mov	r15, rax
	mov	rdx, QWORD PTR -128[rbp]	#count_of_words
	mov	eax, DWORD PTR -116[rbp]
	mov	rsi, rdx
	mov	edi, eax
	call	countWords
	mov	r14d, eax			#count_of_symbols
	mov	eax, r14d			
	movsx	rdx, eax
	sub	rdx, 1
...
.L16:
	...
	mov	r12d, 0				#index_of_correct_words
	mov	eax, r14d
	movsx	rdx, eax
	sub	rdx, 1
...
.L29:
	...
	mov	eax, r12d
	add	eax, 1
	mov	r12d, eax			#index_of_correct_words
.L31:
	mov	BYTE PTR -97[rbp], 1
.L28:
